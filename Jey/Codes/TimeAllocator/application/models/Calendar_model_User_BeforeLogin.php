<?php 
class Calendar_model_User_BeforeLogin extends CI_Model {

var $conf;
	function Calendar_model_User_BeforeLogin(){
		...
		$this->conf=array(
			'start_day' => 'monday',
			'show_next_prev'=>true,
			'next_prev_url' => base_url().'index.php/user/userBeforeLogin'
			);
   ...
   {cal_cell_content}
   		<div class="day_content"><a href= "http://localhost/TimeAllocator/index.php/user/userAddevent/'.$year.'/'.$month.'/{day}"> {day} </div>
   		<div class="content"> {content} </div>
   {/cal_cell_content}
   {cal_cell_content_today}
   		<div class="day_today"><a href= "http://localhost/TimeAllocator/index.php/user/userAddevent/'.$year.'/'.$month.'/{day}">{day} </div>
   		<div class="content"> {content} </div>
   {/cal_cell_content_today}

   {cal_cell_no_content}
   		<div class="day_num"> <a href= "http://localhost/TimeAllocator/index.php/user/userAddevent/'.$year.'/'.$month.'/{day}"> {day} </div>
   {/cal_cell_no_content}
