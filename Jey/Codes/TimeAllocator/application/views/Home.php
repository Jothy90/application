          ...
          <div class="navbar-header">
              ...
              <div class="horizontal-menu navbar-collapse collapse ">
                  <ul class="nav navbar-nav">
                      ...
                      <li ><a href="<?php echo base_url(); ?>index.php/site/cases">Cases</a></li>
                     
                      <li><a href="<?php echo base_url(); ?>index.php/site/Lawyers">Lawyers</a></li>
                  ...
                  <ul class="nav pull-right top-menu">
                      ...
                      <li class="dropdown">
                          ...
                          <ul class="dropdown-menu extended logout">
                              ...
                              <li><a href="<?php echo base_url(); ?>index.php/login/index"><i class="fa fa-key"></i> Log Out</a></li>
                          </ul>
                      </li>
            ...
            <div style="width:320px; float:left; margin-left:60px; height:480px; background-color:#1fb5ad; margin-top:40px;">
                ...
                <div class="slimScrollDiv" style="position: relative; overflow: hidden; width: auto; height: auto;">
                    <ul class="event-list" style="overflow: hidden; margin-left:10px;width: 300px; height: auto;">
                        ...
                        <?php if(count($daydetail) > 0) { ?>
                                
                               <?php for($count=1; $count <= sizeof($daydetail); $count++) { ?>
                                    <li><?php echo 'Case :';echo $daydetail[$count]['casenumber']; echo '  By  -';echo $daydetail[$count]['lawyername'] ?> <a href="#" class="event-close"><i class="ico-close2"></i></a></li>
                                <?php } ?>
                       <?php  } ?>
                    </ul>
