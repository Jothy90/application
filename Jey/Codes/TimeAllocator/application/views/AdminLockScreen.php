...
<!-- Mirrored from bucketadmin.themebucket.net/lock_screen.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 18 Oct 2014 09:20:35 GMT -->
<head>
    <meta charset="utf-8">
    ...
    <link rel="shortcut icon" href="<?php echo base_url(); ?>assests/img/favicon.html">
    ...
    <link href="<?php echo base_url(); ?>assests/css/stylec4ca.css?1" rel="stylesheet">
...
<body class="lock-screen" onload="startTime()">
    ...
    <div class="lock-wrapper">
        ...
        <div class="lock-box text-center">
            ...
            <div class="lock-pwd">
                <form role="form" class="form-inline" action="http://bucketadmin.themebucket.net/index.html">
...
<!-- Mirrored from bucketadmin.themebucket.net/lock_screen.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 18 Oct 2014 09:20:36 GMT -->
</html>
